#!/usr/bin/env bash
# Qwen3-14B GRPO on QuALITY — 2x p5 (16x H100)
# DualKV disabled (FA2 baseline), mb=8
set -x
...
DATA_DIR=${WORKDIR}/data/quality
MODEL_DIR=${WORKDIR}/models/Qwen3-14B
CKPT_DIR=${WORKDIR}/ckpts/quality-qwen3-14b-grpo
SCRIPT_DIR=$(cd "$(dirname "$0")" && pwd)
REWARD_FN=${SCRIPT_DIR}/reward_quality.py
...
$PYTHON -m verl.trainer.main_ppo \
    ...
    trainer.project_name=quality-qwen3-14b-grpo \
    trainer.experiment_name=fa2-mb8 \
