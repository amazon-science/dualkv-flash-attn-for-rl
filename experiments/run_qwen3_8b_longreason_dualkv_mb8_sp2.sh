...
# DualKV + Ulysses SP=2 (DP=4, SP=2)
# This tests DualKV+SP composition: larger micro-batch enabled by both
# prompt deduplication (DualKV) and head splitting (Ulysses SP)
set -x
...
$PYTHON -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=think-n32-dualkv-mb8-sp2 \
