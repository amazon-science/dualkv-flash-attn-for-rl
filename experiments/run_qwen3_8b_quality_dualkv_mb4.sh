#!/usr/bin/env bash
# Qwen3-8B GRPO on QuALITY — 2x p5 (16x H100)
# DualKV enabled
set -x
...
CKPT_DIR=${WORKDIR}/ckpts/quality-qwen3-8b-grpo
...
$PYTHON -m verl.trainer.main_ppo \
    ...
    trainer.project_name=quality-qwen3-8b-grpo \
    trainer.experiment_name=dualkv-mb4 \
